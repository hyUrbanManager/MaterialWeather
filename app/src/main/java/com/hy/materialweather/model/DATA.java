...
public class DATA {
    ...
    public static int locationState = STOP;
     ...
     * @return
     */
    public static final int convertToRes(int code) {
        int res = R.drawable.city_other_cloudy;
        if (code == 100 || code == 103 || code == 300) {
            res = R.drawable.city_other_sunny;
        } else if (code == 101 || code == 102 || code == 104 || code == 500) {
            res = R.drawable.city_other_rainy;
        }
        return res;
    }
