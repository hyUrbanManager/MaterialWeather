...
public class MainActivity extends MVPActivity<WeatherUI, WeatherPresenter>
        implements NavigationView.OnNavigationItemSelectedListener, WeatherUI {
    ...
    @Override
    protected WeatherPresenter createPresenterRefHandler() {
        mHandler = createHandler();
        return new WeatherPresenter(this, this, mHandler);
    }
