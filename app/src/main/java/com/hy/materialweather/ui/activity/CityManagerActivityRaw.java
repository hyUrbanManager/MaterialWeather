...
public class CityManagerActivityRaw extends MVPActivity<CityManagerUI, CityManagerPresenter>
    ...
    protected void initView() {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                CityManagerActivityRaw.this.finish();
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.operate) {
            ...
            Intent intent = new Intent(CityManagerActivityRaw.this, ac);
